...
## COMMENT HERE WITH:
## Your name: Aziz Maredia
## Anyone you worked with on this project: Myself
...
consumer_key = aziz_twitter_info.consumer_key
consumer_secret = aziz_twitter_info.consumer_secret
access_token = aziz_twitter_info.access_token
access_token_secret = aziz_twitter_info.access_token_secret
...
cache_data = "206project2_caching.json"
try: 
	cache_file = open(cache_data,'r')
